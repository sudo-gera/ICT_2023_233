...
public:
    ...
    /// @brief get hash of substrings
    /// @param args - description of substrings in format: s1, b1, e2, s2, b2 e2, ...
...
/// @brief create Pairs objects for each string and fill them with values
/// @param h - PolyHash object
